            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              ...
              <div>
                ...
                <select value={form.account_type || "Standard"} onChange={(e) => updateField("account_type", e.target.value)}
                  ...
                  {["1-Step", "1-Step Monthly", "Advanced", "Apprentice", "Beginner", "Builder", "Classic Growth", "Classic Scale", "Classic Starter", "DH", "DTF", "Diamond Hands", "Direct to Funded", "E2L", "E2L Eval", "E2L OTP", "EOD", "EOD Drawdown", "Elite", "Express MAX", "Express OG", "Fast Track", "Flex", "Fundamental", "Fundamental Eval", "Fundamental OTP", "Gauntlet", "Growth", "Instant", "Intraday", "Lightning", "LucidFlex", "LucidPro", "Merit", "No Activation", "No Scaling", "OneUp", "Option 1", "Option 2", "Pro", "Premium", "Premium Eval", "Premium OTP", "Premium (No Act)", "Rapid", "S2F", "S2L 150K Edge", "S2L 300K Ultra", "S2L 50K Core", "Select", "Signature Futures", "Spark Growth", "Spark Starter", "Standard", "Standard MAX", "Standard OG", "Static", "TCP", "Trail", "Zero"].map((t) => <option key={t} value={t}>{t}</option>)}
                </select>
              </div>
              <div>
